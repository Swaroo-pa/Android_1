...
public class SellActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("SellActivity");
        ...
        // sell will not consider the quantity number if add button is not already pressed
        // for selling the product with a condition of minimum of one quantity is selected
        sell.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(value > 0) {

                    OrderTask orderTask = new OrderTask(SellActivity.this, comment, sell);
                    orderTask.execute();
                }
                else{
